...
static const struct soc_enum i2s_ch_enum =
	SOC_ENUM_SINGLE(ES_I2S_CH, ES_I2S_CH_SHIFT,
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		snd_soc_write(codec, w->reg, 1);
		snd_soc_write(codec, ES_DIG_CLK_EN, 1);
		break;
	case SND_SOC_DAPM_POST_PMD:
		snd_soc_write(codec, w->reg, 0);
		snd_soc_write(codec, ES_DIG_CLK_EN, 0);
		break;
	}
	return 0;
}
...
const struct snd_soc_dapm_widget es_codec_dapm_widgets[] = {
	...
	/* DAC */
	SND_SOC_DAPM_DAC_E("DAC0L", NULL, ES_DAC0L_ON, ES_DAC0L_ON_SHIFT,
		0, es_dac_enable, SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_DAC_E("DAC0R", NULL, ES_DAC0R_ON, ES_DAC0R_ON_SHIFT,
		0, es_dac_enable, SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_DAC_E("DAC1L", NULL, ES_DAC1L_ON, ES_DAC1L_ON_SHIFT,
		0, es_dac_enable, SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_DAC_E("DAC1R", NULL, ES_DAC1R_ON, ES_DAC1R_ON_SHIFT,
		0, es_dac_enable, SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
