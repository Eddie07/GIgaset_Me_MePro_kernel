...
typedef struct {
    ...
    struct timespec t_last,t_now,t_delta;//report at most 1time per 2s by jack.zheng
} fpc1020_data_t;
...
extern int fpc1020_start_input(fpc1020_data_t *fpc1020);
...
extern int fpc1020_start_input(fpc1020_data_t *fpc1020); 
extern int fpc1020_worker_goto_idle(fpc1020_data_t *fpc1020);
extern int fpc1020_sleep(fpc1020_data_t *fpc1020, bool deep_sleep);
